  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      <div className="role-layout rtp-page relative z-10 w-full max-w-[1600px] mx-auto px-4 py-8 sm:px-6">
        <p className="text-xs uppercase tracking-[0.3em] text-[var(--role-accent-light)] font-medium">РТП</p>
        <h2 className="page-title">Рабочее место РТП (Руководитель тушения пожара)</h2>

      <div className="rtp-grid">
        {/* Левая панель: палитра элементов + создание штаба + остатки ОТВ */}
        ...
        {/* Центральная область: схема с обстановкой */}
        <section className="rtp-scheme-area">
          ...
          {headquartersCreated && (
            <p className="scheme-lock-hint">
              После создания штаба схема заблокирована для редактирования.
            </p>
          )}
        </section>
      </div>
