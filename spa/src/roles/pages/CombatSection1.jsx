  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      <div className="role-layout rtp-page relative z-10 w-full max-w-[1600px] mx-auto px-4 py-8 sm:px-6">
        <p className="text-xs uppercase tracking-[0.3em] text-[var(--role-accent-light)] font-medium">Боевой участок 1</p>
        <h2 className="page-title">Боевой участок 1</h2>
        <div className="rtp-grid">
          <aside className="rtp-sidebar">
            <section className="panel panel-equipment"><EquipmentPalette /></section>
